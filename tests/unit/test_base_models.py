...
class TestTechniqueBaseModels:
    def test_get_technique_base_model_id_fixed(self):
        from eval_unlearn.techniques._base_models import get_technique_base_model_id, TECHNIQUE_BASE_MODELS
...
class TestMetricBaseModels:
    ...
    def test_metric_model_info_has_required_fields(self):
        from eval_unlearn.metrics._base_models import METRIC_MODELS, MetricModelInfo
